...
import 'package:fhe_template/module/03_ui_dashboard/pages/uk_dashboard8/controller/uk_dashboard8_controller.dart';
...
class UkDashboard8View extends StatefulWidget {
  const UkDashboard8View({Key? key}) : super(key: key);
