import 'package:fhe_template/module/03_ui_dashboard/pages/uk_dashboard6/controller/uk_dashboard6_controller.dart';
...
class UkDashboard6View extends StatefulWidget {
  const UkDashboard6View({Key? key}) : super(key: key);
