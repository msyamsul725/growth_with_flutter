import 'package:fhe_template/module/03_ui_dashboard/pages/uk_dashboard7/controller/uk_dashboard7_controller.dart';
...
class UkDashboard7View extends StatefulWidget {
  const UkDashboard7View({Key? key}) : super(key: key);
