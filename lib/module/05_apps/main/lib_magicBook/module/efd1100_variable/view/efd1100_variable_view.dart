import 'package:fhe_template/module/05_apps/main/lib_magicBook/module/efd1100_variable/controller/efd1100_variable_controller.dart';
...
class Efd1100VariableView extends StatefulWidget {
  ...
  bool? exercise3() {
    ...
    String text = "300.24a";
    String textNew = text.replaceAll(RegExp(r'[^\d.]'), '');
    price = double.tryParse(textNew) ?? 0;
    return price == 300.24;
  }
