...
import 'package:fhe_template/module/05_apps/main/lib_articale/shared/data/models/article.dart';
                ...
                child: ClipRRect(
                  ...
                  child: ShaderMask(
                    ...
                    child: Image.asset(article.image,
                        height: 50, width: double.infinity, fit: BoxFit.cover),
                  ),
                ),
              ),
            ),
                    ...
                    ClipRRect(
                      ...
                      child: ColorFiltered(
                        colorFilter: const ColorFilter.mode(
                            blackColorOp010, BlendMode.darken),
                        child: Image.asset(
                          article.image,
